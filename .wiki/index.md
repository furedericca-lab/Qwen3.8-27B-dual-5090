...
- [Layer Split Throughput](concepts/layer-split-throughput.md) | status: current | updated: 2026-08-19T13:36:51Z

### debugging

- [Host Integrity](debugging/host-integrity.md) | status: current | updated: 2026-08-17T15:15:00Z
...
- [Layer Split Throughput](concepts/layer-split-throughput.md) | type: concept | status: current
- [Host Integrity](debugging/host-integrity.md) | type: debugging | status: current
- [Host Integrity](debugging/host-integrity.md) | type: debugging | status: current
- [Deployment Baseline](decisions/deployment-baseline.md) | type: decision | status: accepted
- [Deployment Baseline](decisions/deployment-baseline.md) | type: decision | status: accepted
- [Runtime Tuning Freeze](decisions/runtime-tuning-freeze.md) | type: decision | status: accepted
- [First Boot](how-to/first-boot.md) | type: how-to | status: current
- [First Boot](how-to/first-boot.md) | type: how-to | status: current
...
- [Layer Split Throughput](concepts/layer-split-throughput.md) | files: `scripts/llama-server.sh` | anchors: 0 | status: current
- [Host Integrity](debugging/host-integrity.md) | files: `scripts/preflight.sh` | anchors: 0 | status: current
- [Deployment Baseline](decisions/deployment-baseline.md) | files: `scripts/llama-server.sh`, `AGENTS.md` | anchors: 0 | status: accepted
- [Runtime Tuning Freeze](decisions/runtime-tuning-freeze.md) | files: `scripts/llama-server.sh`, `scripts/candidate-server.sh` | anchors: 0 | status: accepted
- [First Boot](how-to/first-boot.md) | files: `scripts/build-llama.sh`, `scripts/inspect-model.sh`, `scripts/inspect-hf-source.sh` ... | anchors: 0 | status: current
- [Hugging Face Source Pin](reference/hf-source.md) | files: `scripts/inspect-hf-source.sh`, `evidence/hf-source.txt`, `evidence/model.sha256` | anchors: 0 | status: current
- [Dual 5090 PCIe Topology](reference/host-topology.md) | files: `scripts/inspect-topology.sh`, `scripts/llama-server.sh` | anchors: 0 | status: current
